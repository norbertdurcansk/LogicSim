...
plot "result/flipflop/GNU_flipflop.dat" index 5 using 2:1  lt rgb "green" lw 3  with steps  title columnheader(1)
plot "result/flipflop/GNU_flipflop.dat" index 7 using 2:1  lt rgb "violet" lw 3  with steps  title columnheader(1)
...
plot "result/flipflop/GNU_flipflop.dat" index 1 using 2:1  lt rgb "black" lw 5 with steps  title columnheader(1)
